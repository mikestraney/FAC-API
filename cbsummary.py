...
def load_data(filename):
    ...
    try:
        ...
        if isinstance(data, list):
            ...
            # Filter data for specific auditor EIN and audit year
            df = df[(df['auditor_ein'] == '560574444') & (df['audit_year'] == 2023)]
            return df
        else:
...
def main():
    ...
    if not data.empty:
        ...
        save_data(summarized_data, 'cbmostcommonprograms.csv')
    else:
